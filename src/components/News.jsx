...
const News = (props) => {
  ...
  //   // let url = `http://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=57a496cf4b774819a7a62fffc6cb9cb0&page=${this.state.page - 1}&pageSize=${props.pageSize}`;
  ...
  return (
    <>
      ...
      >
        NewsLive - Top {capitalizeFirstLetter(props.category)} Headlines
      </h1>
      {loading && <Spinner />}
      <InfiniteScroll
